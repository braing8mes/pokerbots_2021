...
# _RAISE_MIN_STR = {'pre': 0.61, 'post': 0.65}
# _CALL_MIN_STR = {'pre': 0.55, 'post': 0.6}
# _RAISE_MIN_STR = {'pre': 0.6296580340578614, 'post': 0.6569724024504521}
# _CALL_MIN_STR = {'pre': 0.5566381362397362, 'post': 0.5895489940158917}
# _RAISE_MIN_STR = {'pre': 0.6284267869256578, 'post': 0.6570238938206174}
# _CALL_MIN_STR = {'pre': 0.5587722236213436, 'post': 0.5934929835414555}
_RAISE_MIN_STR = {'pre': 0.6519672448740175, 'post': 0.655707055324247}
_CALL_MIN_STR = {'pre': 0.5836895952623877, 'post': 0.6153069587209189}
        ...
        if round_num % mutate_iters == 0:
            if self.total_payoffs < 6 * mutate_iters:
                if not self.mutated:
                    ...
                    print('went extinct again :( undoing mutation...')
                    self.mutated = False
